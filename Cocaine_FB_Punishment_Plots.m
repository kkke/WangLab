...
load('/Users/kechen/MIT Dropbox/Ke Chen/Wang Lab/Manuscripts/DA_Cocaine_Fentanyl/Figures/Figure4/data/Cocaine_FB_Punishment_plot.mat')
...
data_to_plot(i).raw_time(remove_start:remove_stop) =[];
%% plot the data
