clear
load('/Users/kechen/MIT Dropbox/Ke Chen/Wang Lab/Manuscripts/DA_Cocaine_Fentanyl/Figures/Figure3/data/Fentanyl_FB_NAc_summary.mat')
baseline_data = [];
...
save('Fentanyl_FB_Punishment_plot.mat', 'data_to_plot', 'population_psth_avg', 'psth_time', 'summary_testing', 'data_plot')