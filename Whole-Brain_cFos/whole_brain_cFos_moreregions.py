...
thalamus_data = rawData[(rawData.parent_structure_id >= 666) & (rawData.parent_structure_id <= 696) & (rawData.depth == 6)]
...
sub_data_new = sub_data_transpose.rename(index=lambda s: s[3:9])
